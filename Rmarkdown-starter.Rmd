...
### The three components of an R markdown document
...
Note that the `echo = FALSE` and `warning = FALSE` parameters were added to the code chunk to prevent printing of the R code that generated the plot and of warning messages.
